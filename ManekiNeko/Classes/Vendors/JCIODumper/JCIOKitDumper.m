...
@implementation JCIOKitDumper

- (JCIOKitNodeInfo *)dumpIOKitTree {
    ...
    JCIOKitNodeInfo *root = [self _scan:nil service:service options:options];
...
- (JCIOKitNodeInfo *)_scan:(JCIOKitNodeInfo *)parent service:(io_registry_entry_t)service options:(struct options)options {
    ...
    JCIOKitNodeInfo *node = [self _showService:service parent:parent options:options];
    ...
    while (childUpNext) {
        ...
        JCIOKitNodeInfo *childNode = [self _scan:node service:child options:options];
...
- (JCIOKitNodeInfo *)_showService:(io_registry_entry_t)service parent:(JCIOKitNodeInfo *)parent options:(struct options)options {
    io_name_t name;
    ...
    return [[JCIOKitNodeInfo alloc] initWithParent:parent nodeInfoWithInfo:[NSString stringWithCString:name encoding:NSUTF8StringEncoding] properties:translatedProperties];
